//! Global-allocator selection implementation (spec `allocator-selection`, PRD §4.3).

/// The two allocator features are mutually exclusive: a single global allocator
/// can be installed at most once, so enabling both is a compile-time error.
